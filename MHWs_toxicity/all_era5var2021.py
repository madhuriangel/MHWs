...
periods = {
    'Before MHW': ('2021-07-04', '2021-07-17'),
    'During MHW': ('2021-07-18', '2021-08-02'),
    'After MHW':  ('2021-08-03', '2021-08-18'),
}
...
ds_t2m  = open_and_fix('era5/d2m_t2m_2021.nc')[['t2m','d2m']]
ds_msl  = open_and_fix('era5/msl2021_23.nc')[['msl']]
ds_flx  = open_and_fix('era5/slhf_ssr2021.nc')[['slhf','ssr']]
ds_tfl  = open_and_fix('era5/str_sshf2021.nc')[['str','sshf']]
ds_uv   = open_and_fix('era5/uv102021.nc')[['u10','v10']]
