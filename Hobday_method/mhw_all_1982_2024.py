...
def plot_mhw_maps(mean_data, trend_data, mean_p, trend_p, lat, lon, var_label, units, row, gs, fig):
    ...
    ax_mean.set_title(f"Mean {var_label} (1982–2024)", fontsize=title_fontsize)
    ...
    ax_trend.set_title(f"{var_label} Trend (1982–2024)", fontsize=title_fontsize)
...
def main():
    ...
    plt.savefig("plots/mhw_metrics/mhwmetricshobday_1982_2024sig.png", dpi=300)
    plt.show()
