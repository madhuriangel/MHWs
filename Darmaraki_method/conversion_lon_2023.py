...
df = pd.read_csv('mhw_analysis_alterhob/hab2023_d.csv', parse_dates=['periodstart_date','periodend_date'], dayfirst=True)
...
# 4. Save
df.to_csv('mhw_analysis_alterhob/hab2023_conv.csv', index=False)
