...
# Load dataset
##on the mhw_analysis_alterhob folder all the code running and saving done
...
df_ev_max.to_csv("mhw_results/strongest/strongest_mhw_eventstop20_alter.csv", index=False)
df_ev_dur.to_csv("mhw_results/longest/longest_mhw_eventstop20_alter.csv", index=False)
...
ax.set_title("Top 20 Strongest and Longest MHW Events (Alter)", fontsize=title_fontsize)
...
plt.savefig('plots/top20_strong_long_mhw_alterhob.png')
plt.show()
